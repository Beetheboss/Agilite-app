...
const styles = StyleSheet.create({
  ...
  heroNumber: { color: "#F2F0E9", fontSize: 40, lineHeight: 44, fontWeight: "800", letterSpacing: -1.4, marginTop: 3 },
  ...
  quickActionShell: { width: "100%", height: 58, backgroundColor: "#191D1F", borderRadius: 16, borderWidth: 1, borderColor: "#303A32", marginBottom: 8, overflow: "hidden" },
  quickAction: { width: "100%", height: 58, paddingHorizontal: 14, paddingVertical: 0, justifyContent: "center", flexGrow: 0, flexShrink: 0 },
  quickActionInner: { width: "100%", height: 32, flexDirection: "row", alignItems: "center", justifyContent: "center" },
  ...
  quickActionArrow: { width: 32, height: 32, alignItems: "center", justifyContent: "center", flexShrink: 0 },
