...
const styles = StyleSheet.create({
  ...
  quickAction: { width: "100%", height: 52, minHeight: 52, flexGrow: 0, flexShrink: 0, backgroundColor: "#191D1F", borderRadius: 16, paddingHorizontal: 12, borderWidth: 1, borderColor: "#303A32", marginBottom: 8 },
  quickActionInner: { width: "100%", height: 50, flexDirection: "row", alignItems: "center" },
