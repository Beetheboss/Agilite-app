...
const styles = StyleSheet.create({
  ...
  groupHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 12, paddingHorizontal: 20 },
  ...
  moreText: { color: "#A8D46F", fontSize: 12, fontWeight: "700", paddingLeft: 20, marginTop: 2 },
