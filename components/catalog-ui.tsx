...
const styles = StyleSheet.create({
  ...
  rowCard: { width: "100%", height: 76, minHeight: 76, flexGrow: 0, flexShrink: 0, alignSelf: "stretch", backgroundColor: "#191D1F", borderRadius: 18, paddingHorizontal: 12, paddingVertical: 10, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#303A32", overflow: "hidden" },
  ...
  rowBody: { flex: 1, minWidth: 0, minHeight: 40, justifyContent: "center", marginHorizontal: 10 },
  rowTopLine: { height: 21, flexDirection: "row", alignItems: "center" },
  rowTitle: { color: "#F2F0E9", fontSize: 13.5, fontWeight: "700", lineHeight: 18, flex: 1 },
  rowMeta: { height: 17, flexDirection: "row", alignItems: "center", marginTop: 2 },
